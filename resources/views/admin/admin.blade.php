...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('home1') }}" class="nav-link">خانه</a>
      </li>
      {{-- <li class="nav-item d-none d-sm-inline-block">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('productsList') }}" class="nav-link {{ request()->is('products') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>محصولات</p>
                </a>
              </li>            
              <li class="nav-item"> 
                <a href="{{ route('categoryList') }}" class="nav-link {{ request()->is('categories') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>دسته بندی</p>
                </a>
              </li>
  ...
  <footer class="main-footer">
    <strong>هرگونه کپی برداری از مطالب سایت پیگرد قانونی دارد &copy; 1403-1404</strong>
