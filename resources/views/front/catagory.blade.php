				...
				<div class="single-post-catagory mb-30">
					...
					<div class="catagory-content-bg">
						<div class="catagory-content">
							...
							<a href="#" class="post-title">غذای سلامتی</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-12 col-sm-6 col-lg-4">
				<div class="single-post-catagory mb-30">
					...
					<div class="catagory-content-bg">
						<div class="catagory-content">
							<a href="#" class="post-tag">بهترین</a>
							<a href="#" class="post-title">غذای ارگانیک</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-12 col-sm-6 col-lg-4">
				<div class="single-post-catagory mb-30">
					...
					<div class="catagory-content-bg">
						<div class="catagory-content">
							<a href="#" class="post-tag">بهترین</a>
							<a href="#" class="post-title">خوراک سبزیجات</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-12 col-sm-6 col-lg-4">
				<div class="single-post-catagory mb-30">
					...
					<div class="catagory-content-bg">
						<div class="catagory-content">
							<a href="#" class="post-tag">بهترین</a>
							<a href="#" class="post-title">خوراک مرغ</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-12 col-sm-6 col-lg-4">
				<div class="single-post-catagory mb-30">
					...
					<div class="catagory-content-bg">
						<div class="catagory-content">
							<a href="#" class="post-tag">بهترین</a>
							<a href="#" class="post-title">پیتزا</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-12 col-sm-6 col-lg-4">
				<div class="single-post-catagory mb-30">
					...
					<div class="catagory-content-bg">
						<div class="catagory-content">
							<a href="#" class="post-tag">بهترین</a>
							<a href="#" class="post-title">فست فود</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-12 col-sm-6 col-lg-4">
				<div class="single-post-catagory mb-30">
					...
					<div class="catagory-content-bg">
						<div class="catagory-content">
							<a href="#" class="post-tag">بهترین</a>
							<a href="#" class="post-title">برگرها</a>
						</div>
					</div>
				</div>
			</div>
