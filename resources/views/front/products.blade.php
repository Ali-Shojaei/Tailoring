    ...
    @foreach ($Products as $Product)  
      <div class="m-2 w-80 border border-gray-200 dark:border-gray-700 shadow-2xl rounded-lg overflow-hidden">  
        ...
        <div class="m-4 space-y-3">  
          ...
          <a href="{{ route('basket.add' , ['products_id' => $Product->id]) }}" class="inline-flex bg-blue-600 add product-card rounded-md text-white font-bold text-base px-3 py-1 gap-2">  
            افزودن به سبد خرید   
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">  
