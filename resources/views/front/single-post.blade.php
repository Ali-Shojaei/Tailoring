...
<header class="header-area">
	...
	<!-- Logo Area -->
	<div class="logo-area">
		<a href="index.html"><img src="img/core-img/sewing-machine.png" alt=""></a>
	</div>
		...
		<div class="row justify-content-center">
			...
			<div class="col-12 col-lg-8 col-xl-9">
				...
				<div class="comment_area clearfix mb-100">
					<h4 class="mb-50">نظرات کاربران</h4>
					...
					<ol>
						...
						<li class="single_comment_area">
							...
							<div class="comment-content d-flex">
								...
								<div class="comment-meta">
									<div class="d-flex">
										<a href="#" class="post-author">علیرضا آهنگ</a>
										<a href="#" class="post-date">22 آبان 1398</a>
										<a href="#" class="reply">ارسال پاسخ</a>
									</div>
							...
							<ol class="children">
								<li class="single_comment_area">
									...
									<div class="comment-content d-flex">
										...
										<div class="comment-meta">
											<div class="d-flex">
												<a href="#" class="post-author">محمد دوستی</a>
												<a href="#" class="post-date">22 بهمن 1398</a>
												<a href="#" class="reply">ارسال پاسخ</a>
											</div>
											<p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.</p>
										</div>
						...
						<li class="single_comment_area">
							...
							<div class="comment-content d-flex">
								...
								<div class="comment-meta">
									<div class="d-flex">
										<a href="#" class="post-author">حسین اصولی</a>
										<a href="#" class="post-date">22 آبان 1398</a>
										<a href="#" class="reply">ارسال پاسخ</a>
									</div>
									<p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. </p>
					...
					<div class="contact-form-area">
						<form action="#" method="post">
							<div class="row">
								...
								<div class="col-12">
									<input type="text" class="form-control" id="subject" placeholder="وب سایت">
								</div>
								<div class="col-12">
									<textarea name="message" class="form-control" id="message" cols="30" rows="10" placeholder="نظر شما"></textarea>
								</div>
								<div class="col-12">
									<button class="btn bueno-btn mt-30" type="submit">ثبت نظر</button>
								</div>
							</div>
						</form>
					</div>
